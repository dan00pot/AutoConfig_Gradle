...
public class AutoConfig_030 {
	/*###############################--Test Steps--##############################################
	 * AutoConfig-030 Verify that EWSSSO parameters could be configured on AADS
	 * "Objective:
		Verify that EWSSSO parameters could be configured on AADS
		...
		Steps to Reproduce:
		            ...
		            3. Click seach EWSSSO setting in USER, PLATFORM, GROUP, GLOBAL
		            4. Configuring values for them
		Expected Results:
		                1. Login successfully.
		                2. Configuration page is displayed.
		                3. EWSSSO setting is displayed. 
	...
	String testCase = "AutoConfig_030";
	
	final static Logger logger = LogManager.getLogger("AutoConfig_030");

	@Before
	public void beforetestAutoConfig_030() throws Exception {
		logger.info("beforetest AutoConfig_030 starting...\n");
		androidClientDriver = driverMgnt.createAndroidClientDriver();
		webDriver = driverMgnt.createChromeDriver();
		logger.info("beforetest AutoConfig_030 completed...\n");
	}

	@Test
	public void testAutoConfig_030() throws Exception {
		logger.info("AutoConfig_030 - Starting\n");
		try {
			/*================================== Common Steps ======================================*/
			//Login AADS
			...
			//Navigate to Configuration Page
				...
				AADSWebDriver.verify46xx(webDriver,	"EWSSSO 1", testCase);
			...
			logger.error("AutoConfig_030 - Failed with Exception:"
					+ exception + "...\n");
			fail("AutoConfig_030 - Failed - Exception occurs: "
					+ exception.toString());
		}
		logger.info("AutoConfig_030 - test completed\n");
	}
