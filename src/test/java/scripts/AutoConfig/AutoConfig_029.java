...
public class AutoConfig_029 {
	/*###############################--Test Steps--##############################################
	 * AutoConfig-029 Verify that EWSENABLED parameters could be configured on AADS
	 * "Objective:
			Verify that EWSENABLEDparameters could be configured on AADS
			...
			Steps to Reproduce:
			            ...
			            3. Click seach EWSENABLED setting in USER, PLATFORM, GROUP, GLOBAL
			            4. Configuring values for them
			Expected Results:
			                1. Login successfully.
			                2. Configuration page is displayed.
			                3. EWSENABLED setting is displayed. 
	...
	String testCase = "AutoConfig_029";
	
	final static Logger logger = LogManager.getLogger("AutoConfig_029");

	@Before
	public void beforetestAutoConfig_029() throws Exception {
		logger.info("beforetest AutoConfig_029 starting...\n");
		androidClientDriver = driverMgnt.createAndroidClientDriver();
		webDriver = driverMgnt.createChromeDriver();
		logger.info("beforetest AutoConfig_029 completed...\n");
	}

	@Test
	public void testAutoConfig_029() throws Exception {
		logger.info("AutoConfig_029 - Starting\n");
		try {
			/*================================== Common Steps ======================================*/
			//Login AADS
			...
			//Navigate to Configuration Page
				...
				AADSWebDriver.configurationPageSettingVariable(webDriver, "User", "EWSENABLED", true, "1");
				AADSWebDriver.configurationPageSettingVariable(webDriver, "Group", "EWSENABLED", true, "1");
				AADSWebDriver.configurationPageSettingVariable(webDriver, "Global", "EWSENABLED", true, "1");
				AADSWebDriver.configurationPageSettingVariable(webDriver, "Platform", "EWSENABLED", true, "1");
				...
				AADSWebDriver.verify46xx(webDriver, "EWSENABLED 1", testCase);
			...
			logger.error("AutoConfig_029 - Failed with Exception:"
					+ exception + "...\n");
			fail("AutoConfig_029 - Failed - Exception occurs: "
					+ exception.toString());
		} 
		logger.info("AutoConfig_029 - test completed\n");
	}
