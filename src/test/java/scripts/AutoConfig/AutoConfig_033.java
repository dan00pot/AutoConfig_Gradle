...
public class AutoConfig_033 {
	/*###############################--Test Steps--##############################################
	 *AutoConfig-033 Verify that EWSUSERNAME parameters could be configured on AADS 
	 * "Objective:
			Verify that EWSUSERNAME parameters could be configured on AADS
			...
			Steps to Reproduce:
			            ...
			            3. Click seach EWSUSERNAME setting in USER, PLATFORM, GROUP, GLOBAL
			            4. Configuring values for them
			Expected Results:
			                1. Login successfully.
			                2. Configuration page is displayed.
			                3. EWSUSERNAME setting is displayed. 
	...
	String testCase = "AutoConfig_033";
	
	final static Logger logger = LogManager.getLogger("AutoConfig_033");

	@Before
	public void beforetestAutoConfig_033() throws Exception {
		logger.info("beforetest AutoConfig_033 starting...\n");
		androidClientDriver = driverMgnt.createAndroidClientDriver();
		webDriver = driverMgnt.createChromeDriver();
		logger.info("beforetest AutoConfig_033 completed...\n");
	}

	@Test
	public void testAutoConfig_033() throws Exception {
		logger.info("AutoConfig_033 - Starting\n");
		try {
			/*================================== Common Steps ======================================*/
			//Login AADS
			...
			// Step 1
				...
				AADSWebDriver.configurationPageSettingVariable(webDriver, "User", "EWSUSERNAME", true, "1");
				...
				AADSWebDriver.verify46xx(webDriver,	"EWSUSERNAME 1", testCase);
			...
			logger.error("AutoConfig_033 - Failed with Exception:"	+ exception + "...\n");
			fail("AutoConfig_033 - Failed - Exception occurs: "	+ exception.toString());
		} 
		logger.info("AutoConfig_033 - test completed\n");
	}
